function [PSD, w, r, Var1] = kspec( S, nfft, ds, win )
% function [PSD, w, r, Var1] = kspec( S, nfft, ds, win );
%
...
% 2*pi (useful for comparing to local inertial frequency from sw_f.m). To convert output PSD to [variable units^2/(radians/sample
